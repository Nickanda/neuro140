...
class Agent():
    def __init__(self, epsilon_decay, epsilon_min, 
        ...
        self.epsilon = 0.5437504140804508                                                               
        ...
        if load_model:
            self.model.load_weights("./Deep Q-Learning - PACMAN/final_version_v2.weights.h5")        
    ...
    def create_model(self):
        ...
        model = Sequential()
        # CNN architecture for processing image data from gymnasium
        model.add(
            Input(shape=(210, 160, 3))
        )  # Assuming resized and stacked frames (4 frames)
...
if __name__ == '__main__':
    with tf.device('/device:GPU:0'):
        ...
        for episode in range(num_episodes):
            ...
            if (episode % 25 == 0):
                agent.model.save_weights("./Deep Q-Learning - PACMAN/final_version_cnn_v1_05.weights.h5")
